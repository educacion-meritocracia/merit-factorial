...
time. Most research on these beliefs remains cross-sectional, limiting
our understanding of how they develop through school-based socialization
...
and school-based sorting mechanisms become more salient
...
\citeproc{ref-tang_meritocratic_2025}{Tang et al., 2025}). We therefore
test measurement invariance across two cohorts of Chilean students (8th
and 10th graders) and longitudinally within the same students across two
waves (2023--2024). Without invariance, observed differences across
cohorts or over time may reflect changes in item interpretation rather
than substantive change in the underlying constructs
...
Establishing this measurement foundation is essential both for
distinguishing developmental change from measurement non-equivalence and
for examining how meritocratic beliefs relate to attitudes toward
...
example, through subtraction scores (as in the
...
education as legitimate routes to mobility
(\citeproc{ref-batruch_belief_2022}{Batruch et al., 2022};
\citeproc{ref-chauvin_school_2026}{Chauvin et al., 2026};
\citeproc{ref-darnon_where_2018}{Darnon et al., 2018};
...
(\citeproc{ref-liu_does_2025}{C. Liu \& Wang, 2025};
\citeproc{ref-tang_meritocratic_2025}{Tang et al., 2025}). This duality
...
perceived non-meritocracy, preferred meritocracy, and preferred
non-meritocracy---showing that adolescents differentiate between
perceptions and preferences, and between merit and non-merit, and that
endorsement of merit can coexist with recognition of non-meritocratic
advantage. These findings support modeling school meritocracy as
distinct yet related dimensions rather than collapsing them into a
single score, particularly when using zero-sum indices. The scale is
strictly invariant over time for individual students, providing a robust
basis for longitudinal analysis, but it does not achieve cross-level
equivalence; therefore, comparisons across educational stages require
caution. More broadly, what is often interpreted as a change in belief
in meritocracy may partly reflect increasing recognition of
non-meritocratic constraints rather than declining endorsement of merit,
consistent with recent accounts of dual consciousness
(\citeproc{ref-liu_does_2025}{C. Liu \& Wang, 2025};
\citeproc{ref-tang_meritocratic_2025}{Tang et al., 2025};
...
items per factor, which limits content coverage and reliability. The
design also includes only two waves and two school levels, restricting
the analysis of longer developmental trajectories. In addition,
cross-level non-invariance suggests the need to refine
perceived-meritocracy items and test for differential item functioning.
Future research should expand the item pool, include more waves and age
groups, better distinguish types of non-meritocratic beliefs, and
examine how these dimensions relate to inequality legitimation across
school contexts. Overall, this study provides a stronger foundation for
analyzing how school-based meritocratic socialization shapes
