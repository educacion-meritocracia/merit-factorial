...
\begin{tabular}{>{\centering\arraybackslash}p{4.3cm}>{\centering\arraybackslash}p{2.3cm}>{\centering\arraybackslash}p{1.7cm}>{\centering\arraybackslash}p{1.3cm}>{\centering\arraybackslash}p{2.3cm}>{\centering\arraybackslash}p{3.4cm}}
\toprule
