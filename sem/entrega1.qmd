...
Para evaluar nuestras hipótesis, se emplearon análisis factoriales exploratorios (EFA) y confirmatorios (CFA) basados en un modelo latente de medición de cuatro factores [@castillo_multidimensional_2023], con estimador de Mínimos Cuadrados Ponderados Diagonales (DWLS) debido a la naturaleza ordinal de los ítems [@kline_principles_2023]. El ajuste del modelo se evaluó con base en los criterios propuestos por Brown [-@brown_confirmatory_2015]: CFI > 0.95; TLI > 0.95; RMSEA < 0.06.
