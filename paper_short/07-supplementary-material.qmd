...
knitr::include_graphics(here('paper_short/imagenes/w1.png'))
```
...
knitr::include_graphics(here('paper_short/imagenes/w2.png'))
```
...
knitr::include_graphics(here('paper_short/imagenes/basica.png'))
```
...
knitr::include_graphics(here('paper_short/imagenes/media.png'))
```
...
table_Sx %>% 
  ...
  kableExtra::kable_styling(full_width = F,
                            ...
                            font_size = 10) %>%
  kableExtra::column_spec(column = 1, width = "4.3cm") %>%
  kableExtra::column_spec(column = 2, width = "2.3cm") %>%
  kableExtra::column_spec(column = 3, width = "1.7cm") %>%
  kableExtra::column_spec(column = 4, width = "1.3cm") %>%
  kableExtra::column_spec(column = 5, width = "2.3cm") %>%
  kableExtra::column_spec(column = 6, width = "3.4cm")
```
