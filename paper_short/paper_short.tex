...
legitimacy of social arrangements. Schools are key institutions of
meritocratic socialization, making adolescence a crucial period for
studying how these beliefs are formed. However, research on adolescents'
meritocratic beliefs is scarce and has often relied on unidimensional
approaches, usually conflating different meritocratic dimensions. This
study assess the structure and equivalence of meritocratic beliefs,
distinguishing between perceived and preferred meritocracy, and between
meritocracy and non-meritocracy. Using two-wave panel survey data from
Chilean students in 8th and 10th grade (Wave 1: N = 846; Wave 2: N =
662), we assess whether these dimensions can be distinguished, compared
across school stages, and measured equivalently over time. Results
support a longitudinally stable four-factor structure and show that
endorsement of merit can coexist with recognition of non-meritocratic
advantage. \newline \textbf{Keywords}: Meritocracy · Schools ·
Measurement invariance · Socialization · Chile
\end{abstract}
...
Students encounter this ideal through discourse as well as grading,
selection, and tracking, which make merit visible and consequential
...
\citeproc{ref-zhou_equalization_2019}{Zhou, 2019}). Stronger endorsement
of school meritocracy has been linked to greater justification of
inequality (\citeproc{ref-batruch_belief_2022}{Batruch et al., 2022};
\citeproc{ref-lampert_meritocratic_2013}{Lampert, 2013};
\citeproc{ref-wiederkehr_belief_2015}{Wiederkehr et al., 2015}), even
when students recognize structural constraints, reflecting a form of
dual consciousness (\citeproc{ref-liu_does_2025}{C. Liu \& Wang, 2025};
...
\citeproc{ref-resh_sense_2014}{Resh \& Sabbagh, 2014}), potentially
reshaping how students interpret meritocratic narratives in light of
lived constraints (\citeproc{ref-allen_top_2016}{Allen, 2016};
...
and for examining how meritocratic beliefs relate to attitudes toward
...
evolve during adolescence, shedding light on the role of schools in
shaping these beliefs and their implications for attitudes toward
inequality and social mobility.
...
formulation (\citeproc{ref-mijs_paradox_2021}{Mijs, 2021};
...
In school research, these measurement challenges have received limited
attention. One recent exception is Chauvin et al.
(\citeproc{ref-chauvin_school_2026}{2026}), who proposes a
multidimensional measure of school meritocracy that distinguishes equity
and ability from a general factor; however, it relies on a single scale,
focuses solely on teachers, and is limited to perceived meritocracy.
Another relevant study, by Castillo et al.
...
students distinguish between perceptions of social and school
meritocracy. However, these studies do not assess whether these
dimensions are stable across cohorts or over time, limiting our
...
More broadly, meritocratic framing encourages students to interpret
success and failure in individual terms, reinforcing personal
responsibility while downplaying structural conditions
(\citeproc{ref-darnon_where_2018}{Darnon et al., 2018};
...
Saul, 2006}). These beliefs matter beyond school: perceiving schools as
...
redistribution, and greater acceptance of unequal access to social
...
thus shape not only academic trajectories, but also distributive beliefs
that may normalize wider inequalities.
...
(\citeproc{ref-putnick_measurement_2016}{Putnick \& Bornstein, 2016}).
We implemented two complementary strategies: cross-group invariance
across school levels (primary vs.~secondary students) and longitudinal
...
society\footnote{Despite the lack of cohort invariance, re-estimating
  the longitudinal invariance models with cohort as a covariate
  predicting each latent factor did not materially change model fit or
  conclusions, suggesting that invariance over time remains tenable.
  These robustness checks are reported in the Supplementary Material.}.
...
support measuring school meritocracy as a set of related but distinct
...
interpreted in the literature as a change in ``belief in meritocracy''
may instead reflect increasing recognition of non-meritocratic
constraints rather than a straightforward decline in merit endorsement,
consistent with recent education-focused accounts of dual consciousness
(\citeproc{ref-liu_does_2025}{C. Liu \& Wang, 2025};
\citeproc{ref-tang_meritocratic_2025}{Tang et al., 2025};
\citeproc{ref-zhu_meritocratic_2025}{Zhu, 2025}).

At the same time, the scale is strictly invariant over time within
students, providing a robust basis for longitudinal analysis. This
strengthens the study of developmental change in meritocratic beliefs by
allowing within-student differences over time to be interpreted more
confidently as substantive rather than as measurement artifacts.
However, the scale does not achieve invariance across cohorts, so
comparisons across educational stages should be made with caution. This
suggests that students at different stages of schooling differ in how
they interpret whether effort is rewarded in society, possibly because
cumulative exposure to schooling makes effort appear less sufficient for
success among older students (\citeproc{ref-tang_meritocratic_2025}{Tang
et al., 2025}).

Despite its contributions, this study has limitations that point to
future research. The scale is deliberately minimalist, with only two
items per factor, which limits content coverage and reliability, and the
design includes only two waves and two school levels, restricting the
analysis of longer developmental trajectories. In addition, cross-level
non-invariance suggests the need to refine perceived-meritocracy items
and test for differential item functioning. Beyond measurement, future
research should examine the substantive implications of these beliefs in
school settings, including whether different meritocratic dimensions
shape students' sense of injustice, academic motivation and performance,
attitudes toward selection and tracking, and broader views about
inequality and educational opportunity. Such work would help clarify not
only how meritocratic beliefs are structured, but also how they matter
for students' educational experiences and for the legitimation of
inequality in school contexts.
