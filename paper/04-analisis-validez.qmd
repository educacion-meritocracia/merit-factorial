...
Despite this descriptive variation, the superior fit of the constrained model suggests these differences do not represent substantively meaningful change, but rather reflect sampling variability around stable underlying parameters. Overall, the evidence supports temporal stability in the structural relationships between market justice preferences and meritocratic belief dimensions, particularly for the theoretically central preference constructs.

Taken together, these validity findings illuminate the core purpose of the meritocracy scale: to provide a multidimensional assessment that distinguishes between what individuals perceive as actual operating principles in society (perceptions) versus what they believe should guide distribution (preferences), while simultaneously differentiating between meritocratic and non-meritocratic criteria within each domain. 

The differential patterns of association with market justice preferences—particularly the stronger links to non-meritocratic dimensions—demonstrate that the scale captures theoretically meaningful variation that would be obscured by unidimensional measures. 

This measurement structure enables researchers to identify whether endorsement of market-based allocation systems stems primarily from genuine meritocratic ideals or from broader acceptance of market-generated advantages, including those derived from social connections and inherited privilege. Such differentiation is essential for understanding the ideological foundations of inequality attitudes and the conditions under which meritocratic discourse legitimates versus challenges distributive inequalities.