...
rewards (\citeproc{ref-chauvin_school_2026}{Chauvin et al., 2026};
\citeproc{ref-vandewerfhorst_meritocracy_2024}{Van De Werfhorst, 2024}),
and institutionalize it as a lived experience through grading, tracking,
and selection (\citeproc{ref-darnon_where_2018}{Darnon, Wiederkehr, et
al., 2018}; \citeproc{ref-traini_stratification_2022}{Traini, 2022}).
Students who believe that effort and talent determine outcomes tend to
interpret success and failure in individual terms, with consequences
that extend from individual motivation to school climate and beliefs
about social inequality
(\citeproc{ref-castillo_socialization_2024}{Castillo et al., 2024};
\citeproc{ref-resh_sense_2018a}{Resh, 2018};
...
judgments extend to privilege and structural advantage, is therefore a
question with direct relevance for educational practice, curriculum
design, and efforts to promote equity in schools.
...
true, and treat meritocratic and privilege-based explanations as
opposite ends of a single scale. A student who perceives that only
connections and wealth get ahead but strongly believes that effort and
talent should determine outcomes holds a fundamentally different
orientation from a student who is indifferent to both, yet current
instruments would assign them similar scores. Conflating these
dimensions risks misidentifying what students actually believe and, by
extension, what educational interventions should address.
...
shape students' orientations toward fairness and inequality.
...
limited attention. Chauvin et al.
(\citeproc{ref-chauvin_school_2026}{2026}) propose a multidimensional
measure of school meritocracy that distinguishes between equity and
ability dimensions, but their scale applies only to teachers and remains
restricted to perceived meritocracy. Castillo et al.
(\citeproc{ref-castillo_socialization_2024}{2024}) apply the four-factor
framework to a sample of Chilean 10th graders and report that students
differentiate perceptions from preferences and meritocratic from
privilege-based principles; however, that study relies on item-level
descriptives and bivariate associations rather than a formal factorial
measurement model, meaning the multidimensional structure has not been
tested through confirmatory factor analysis in a student population.
Beyond this, no study has examined whether these dimensions are stable
across age cohorts or over time, which limits understanding of how
meritocratic beliefs develop through schooling and whether observed
differences across stages reflect substantive change or measurement
non-equivalence. This gap is consequential: without an established and
tested measurement model, let alone evidence of its equivalence across
school levels and waves, findings from different student populations
cannot be meaningfully compared, and claims about the development of
meritocratic beliefs during adolescence remain on uncertain empirical
ground.
...
in many cases, on family resources and social networks Otero et al.
(\citeproc{ref-otero_neighbourhood_2017}{2017}). Chile consistently
ranks among the most educationally stratified countries in the OECD,
with large and persistent gaps in learning outcomes across income groups
that the expansion of educational access has not resolved
...
Building on Castillo et
al.'s(\citeproc{ref-castillo_multidimensional_2023}{2023}) framework and
...
for each student; no directly identifying information was collected for
students or their guardians in the analytic files.
...
Each factor is measured by only two indicators, the minimum required for
identification in a Confirmatory Factor Analysis framework. This is a
deliberate trade-off in the original scale design
(\citeproc{ref-castillo_multidimensional_2023}{Castillo et al., 2023}),
which prioritizes parsimony for large-scale survey use over content
breadth and reliability. As a consequence, internal consistency cannot
be computed in the conventional sense, and the two items per dimension
may not fully capture the construct's full theoretical range.
Factor-level estimates should therefore be interpreted with appropriate
caution throughout the results and discussion.
...
Perceived meritocracy and perceived privilege are negatively correlated
(\(r\) = −0.21), suggesting that students who perceive greater
meritocracy in society tend to view a weaker role for connections and
family wealth. At the same time, perceived privilege is positively
related to meritocratic preferences (\(r\) = 0.48, the strongest
correlation in the model), suggesting that perceiving society as
rewarding contacts and wealth may coincide with stronger endorsement of
meritocratic ideals, a pattern we return to in the discussion as a
normative-reactive response. Finally, meritocratic preferences and
privilege acceptance are modestly positively correlated (\(r\) = 0.15),
and perceived privilege and privilege acceptance are also positively
...
recognition in which students strongly acknowledge privilege-based
...
privilege-based factors (especially contacts and family wealth) and, to
...
\begin{tabular}{>{\centering\arraybackslash}p{2cm}cc>{\centering\arraybackslash}p{2 cm}cccc}
\toprule
...
and these privilege-based factors elicit the most disagreement within
...
\begin{tabular}{>{\centering\arraybackslash}p{2cm}cc>{\centering\arraybackslash}p{2 cm}>{\centering\arraybackslash}p{2 cm}ccc}
\toprule
Model & $\chi^2$ (df) & CFI & RMSEA (90\% CI) & $\Delta \chi^2$ ($\Delta$df) & $\Delta$CFI & $\Delta$RMSEA & Decision\\
\midrule
...
evaluating meritocratic and privilege-based criteria, which limits the
...
experience-laden lens. The SES-differentiated trajectories documented by
Tang et al. (\citeproc{ref-tang_meritocratic_2025}{2025}) are
instructive here: Chinese students from lower socioeconomic backgrounds
initially recognize the weight of structural advantage to a lesser
extent than their higher-SES peers, but converge progressively as they
accumulate educational experience. If a similar dynamic operates
...
reflect this convergence process, as students across social positions
increasingly confront the limits of effort as a sufficient explanation
for outcomes. In Chile's highly stratified system, where the gap between
meritocratic discourse and structural reality is particularly visible,
students from lower socioeconomic backgrounds have been shown to
experience this gap as a moral grievance
(\citeproc{ref-neutaguayo_neoliberalism_2025}{Neut Aguayo et al.,
2025}), which is consistent with the idea that the construct of
perceived effort becomes more contested, and therefore less stable
across students, as schooling advances. For researchers, this is a call
to move beyond assuming that meritocracy scales travel unchanged across
school levels: future work should prioritize stage-sensitive item
...
study offers a more reliable, if still provisional, foundation for
studying how school-based meritocratic socialization shapes students'
interpretations of fairness and inequality.
