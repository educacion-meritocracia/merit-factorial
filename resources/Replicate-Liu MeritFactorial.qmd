...
subtitle: "Longitudinal Invariance Liu et al. (2017) Replication"
...
###########################################
# Covarianzas entre factores (entre olas)
###########################################
...
###########################################
# Medias latentes (referencia = ola 1)
###########################################
...
###########################################
# Varianzas únicas (ola 1 = 1, ola 2 libre)
###########################################
...
###########################################
# Umbrales (sin igualar en este modelo)
###########################################

perceffort1     | pef1_t1*t1 + pef1_t2*t2
perceffort2     | pef2_t1*t1 + pef2_t2*t2
perctalent1     | pt1_t1*t1 + pt1_t2*t2
perctalent2     | pt2_t1*t1 + pt2_t2*t2

percrichparents1| prp1_t1*t1 + prp1_t2*t2
percrichparents2| prp2_t1*t1 + prp2_t2*t2
perccontact1    | pc1_t1*t1 + pc1_t2*t2
perccontact2    | pc2_t1*t1 + pc2_t2*t2

prefeffort1     | pfe1_t1*t1 + pfe1_t2*t2
prefeffort2     | pfe2_t1*t1 + pfe2_t2*t2
preftalent1     | prt1_t1*t1 + prt1_t2*t2
preftalent2     | prt2_t1*t1 + prt2_t2*t2

prefrichparents1| pfrp1_t1*t1 + pfrp1_t2*t2
prefrichparents2| pfrp2_t1*t1 + pfrp2_t2*t2
prefcontact1    | pfc1_t1*t1 + pfc1_t2*t2
prefcontact2    | pfc2_t1*t1 + pfc2_t2*t2
...
### Anova Weak and Strong Invariance

```{r}
anova(fit_loadinginv, fit_thresholdinv)

mi_threshold <- lavTestScore(fit_thresholdinv)
...
mi_uniqueness <- lavTestScore(fit_uniquenessinv)
