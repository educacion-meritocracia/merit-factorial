...
fit_configural <- cfa(model_configural, data = db_invariance, meanstructure = TRUE)
...
fit_metric <- cfa(model_metric, data = db_invariance, meanstructure = TRUE)
...
fit_scalar <- cfa(model_scalar, data = db_invariance, meanstructure = TRUE)
...
fit_strict <- cfa(model_strict, data = db_invariance, meanstructure = TRUE)
...
```{r}
#| label: Invariance Source Analysis
#| tbl-cap: "Compare Models"
#| results: asis
#| warning: false
