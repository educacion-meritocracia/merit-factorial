...
summary(mgeneral_cfa, fit.measures = T, standardized = T)
summary(mbasica_cfa, fit.measures = T, standardized = T)
summary(mmedia_cfa, fit.measures = T, standardized = T) # revisar especificaciones
```
