...
**Escala de percepciones y preferencias sobre meritocracia (PPMS)**: Las variables incluidas en el modelo de medición se operacionalizan según los ítems propuestos por Castillo et al. [-@castillo_multidimensional_2023]
...
**Market Justice Preferences**: Índice promedio de tres indicadores que abordan el grado de justificación respecto a si el acceso a los servicios sociales en salud, pensiones y educación debe estar condicionado por los ingresos ($\alpha$ = 0.83). 
